...
public class ProductController {
    ...
    public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product) {
        ...
        if (productAdded.getPrix() == 0)
            throw new ProduitGratuitException("Impossible d'enregistrer un produit avec un prix de vente égal à 0");
    ...
    @ApiOperation(value = "Affiche les produits avec leurs marges")
